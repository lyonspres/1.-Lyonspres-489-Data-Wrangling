...
## Rename the variabels so they can be worked with
...
## Rework the demographics so that they can be summarised in a table for descriptive statistics in method section

domain_list <- list("Age",
                  "Gender", 
                  "Education_Level",
                  "Parent"
                )
...
## Below information is to help with the above when necessary
...
##3.	Ethnicity (Pākehā/NZ European, Māori, Pacific Peoples [please specify], Asian [please specify], Other Ethnicity [please specify])
##4.	Education (None, Secondary School Qualification, Tertiary Qualification [please specify your highest level of tertiary qualification]) 
##5.	Do you have children? (Yes, No – if yes, what is the age of your oldest child)
```
